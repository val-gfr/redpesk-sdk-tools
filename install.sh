...
function setup_ssh {
    ...
    ${LXC} exec "${CONTAINER_NAME}" -- bash -c "mkdir -p ${CONTAINER_SSH_DIR}"
    ${LXC} exec "${CONTAINER_NAME}" -- bash -c "chmod 0700 ${CONTAINER_SSH_DIR}"
    ${LXC} exec "${CONTAINER_NAME}" -- bash -c "chown devel:devel ${CONTAINER_SSH_DIR}"
