...
${RUN_DEBUG} ${INSTALL_SCRIPT} create -c localbuilder-test-28 -t localbuilder -i redpesk-builder/28 --non-interactive
...
${RUN_DEBUG} ${INSTALL_SCRIPT} clean -c localbuilder-test-28 --non-interactive